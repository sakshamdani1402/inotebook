...
const AddNote = (props) => {
    ...
    return <div className="container my-4 add-note-container">
        <h1>Add a note</h1>
        <form>
            <div className="mb-3">
            ...
            <button disabled={note.title.length<3 || note.description.length<3} type="submit" className="btn btn-primary" onClick={handleClick}>Add this note</button>
        </form>
    </div>
};
